...
<xsl:template match="/clam/parameters">
    ...
    <div id="parameters" class="box parameters">
        ...
        <div id="startbutton">
            <input id="buttonstartbutton" type="submit" class="start" value="Run" disabled="disabled" onmouseover="MouseOverDisabled(this);" onmouseout="MouseOverDisabled(this);"/> <!--  type="submit" -->
        </div>
    </div>
    </form>
</xsl:template>
