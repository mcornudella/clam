            ...
            <xsl:if test="contains(/clam/@interfaceoptions,'inputfromweb')">
				<div class="urluploadform">
		            ...
		            <div id="urlupload" style="display: none;">
		                ...
		                <xsl:text> </xsl:text><p style="padding: 7px;">Enter the file URL <xsl:text> </xsl:text> <input id="urluploadfile" value="http://" /> <xsl:text> </xsl:text><input id="urluploadsubmit" class="uploadbutton" type="submit" value="Retrieve and add file" style="padding: 7px;"/></p> 
